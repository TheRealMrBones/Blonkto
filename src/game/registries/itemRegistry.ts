...
import StoneBlock from '../world/blocks/stoneBlock';
...
ItemRegistry.Register("stone_block", new Item("Stone Block", 64, ASSETS.STONE_BLOCK).componentHandler.addComponent(new BuildComponent(new StoneBlock)));
